...
This section discusses interoperability with related Jakarta EE footnote:[Jakarta EE Platform 12, https://jakarta.ee/specifications/platform/12/] specifications. When operating within a Jakarta EE product, the availability of other Jakarta EE technologies depends on whether the Jakarta EE Core profile, Jakarta EE Web profile, or Jakarta EE Platform is used.

=== Jakarta Contexts and Dependency Injection

// TODO update to CDI version for Jakarta EE 12
...
// TODO update to Interceptors version for Jakarta EE 12
...
// TODO update to Transactions version for Jakarta EE 12
...
// TODO update to Bean Validation version for Jakarta EE 12
